...
class ExperimentalPredictions:
    ...
    # En la clase ExperimentalPredictions
    def _predict_diffraction_peak(self) -> float:
        """q₀ = 2π/L_E8 (sin ajuste)"""
        L = RESMAConstants.L_E8 * ureg.meter          # ← cantidad con unidades
...
# ============================================================================
# 11. SIMULACIÓN COMPLETA Y VERIFICACIÓN DE INTEGRIDAD (CORREGIDO)
# ============================================================================
...
def simulate_resma_multiverse(n_leaves: int = 5000, n_nodes: int = 50000,
    ...
    # FIX: Cambiar len(emuna.emuna_function) por shape del projector
...
# ============================================================================
# EJECUCIÓN PRINCIPAL CON VALIDACIÓN DE RECURSOS
# ============================================================================
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("✅ Simulación minimal exitosa")
        print("BF:", results['bayes_factor'])
        print("Veredicto:", results['verdict'])
    ...
    Si BF > 10: RESMA es mejor modelo que nulls (no "verdad absoluta")
    Si BF < 0.1: RESMA es falsada por modelos más simples""")

    except Exception as e:
        logger.exception("Error crítico en simulación")
        print(f"\nError: {e}")
        print("Verifica recursos y parámetros. Usa 'n_leaves=100' para prueba mínima.")