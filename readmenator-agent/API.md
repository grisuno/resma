...
### demo_resma (method) `def demo_resma()`
- Defined: `demo_mini_resma.py:49`
- Doc: Demostración rápida de la arquitectura RESMA-Garnier

### __init__ (method) `def __init__(self, in_features, out_features, device)`
...
### visualize_uased_geometry (function) `def visualize_uased_geometry()`
...
### __init__ (method) `def __init__(self, layer_sizes, scale, device)`
- Defined: `garnier_nn.py:69`
- Imported by: `test_ultra_simple.py`, `train_mini_resma.py`, `train_profile.py`

### _build_garnier_topology (method) `def _build_garnier_topology(self)`
...
### activar_perfilado (method) `def activar_perfilado(self)`
- Defined: `garnier_nn.py:168`
- Doc: Activar perfilado de tiempo en toda la red
- Imported by: `test_ultra_simple.py`, `train_mini_resma.py`, `train_profile.py`

### mostrar_estadisticas_perfilado (method) `def mostrar_estadisticas_perfilado(self)`
- Defined: `garnier_nn.py:183`
- Doc: Mostrar estadísticas de perfilado
- Imported by: `test_ultra_simple.py`, `train_mini_resma.py`, `train_profile.py`

### entrenar_con_perfilado (method) `def entrenar_con_perfilado(self, train_loader, epochs, lr)`
- Defined: `garnier_nn.py:201`
- Doc: Entrenamiento con perfilado detallado
- Imported by: `test_ultra_simple.py`, `train_mini_resma.py`, `train_profile.py`

### entrenar (method) `def entrenar(self, train_loader, epochs, lr)`
...
### simulate_resma_multiverse (method) `def simulate_resma_multiverse(n_leaves, n_nodes, seed)`
- Defined: `main.py:764`
- Doc: Pipeline completo RESMA 3.0 con verificaciones de integridad.

### validate_dimension (method) `def validate_dimension(alpha)`
- Defined: `main.py:62`
- Doc: α ∈ (0,1) por definición de dimensión fractal

### validate_pt_symmetry (method) `def validate_pt_symmetry(kappa, Omega, chi)`
- Defined: `main.py:68`
- Doc: Verificar κ/Ω < χ/Ω < 1 para PT-simetría

### validate_connectome_size (method) `def validate_connectome_size(n_nodes)`
- Defined: `main.py:79`
...
### spectral_density (method) `def spectral_density(self, omega)`
- Defined: `main.py:106`
- Doc: Densidad espectral continua ρ(ω) para álgebra tipo III₁.

### modular_entropy (method) `def modular_entropy(self)`
- Defined: `main.py:114`
- Doc: Entropía modular S = ∫ ρ(ω)logρ(ω) dω (aproximada numéricamente)

### bures_distance (method) `def bures_distance(self, other)`
- Defined: `main.py:121`

### _spectral_moments (method) `def _spectral_moments(self, n)`
- Defined: `main.py:132`
- Doc: Momentos espectrales Tr(ρ^k) para k=1..n

### __init__ (method) `def __init__(self, n_leaves, seed)`
- Defined: `main.py:150`
- Doc: Args:

### _initialize_leaves (method) `def _initialize_leaves(self)`
- Defined: `main.py:168`
- Doc: Genera hojas con gaps espectrales distribuidos

### _generate_gibbs_measure (method) `def _generate_gibbs_measure(self)`
- Defined: `main.py:181`
- Doc: Medida de Gibbs μ(i,j) = exp(-β·W₂²(ρ_i, ρ_j))

### _construct_global_state (method) `def _construct_global_state(self)`
- Defined: `main.py:203`
- Doc: Estado global: mapa de pesos por hoja (no matriz)

### __init__ (method) `def __init__(self, leaf, threshold)`
- Defined: `main.py:226`

### _construct_cptp_map (method) `def _construct_cptp_map(self)`
- Defined: `main.py:231`
- Doc: Canal de Kraus: Ĥ(ρ) = Σ K_i ρ K_i† (solo si defecto > umbral)

### _local_jump_operator (method) `def _local_jump_operator(self, power)`
- Defined: `main.py:240`
- Doc: K_j = Δ_S^(1/4) · σ_j · Δ_S^(1/4) en representación de 2×2 local.

### apply_branching (method) `def apply_branching(self, state_vector)`
- Defined: `main.py:255`
- Doc: Aplicar canal CPTP a vector de estado local (dim=2)

### __init__ (method) `def __init__(self, universe, n_samples)`
- Defined: `main.py:276`

### _construct_hardy_state (method) `def _construct_hardy_state(self)`
- Defined: `main.py:282`
- Doc: E(z) ∈ H²(ℂ⁺): Función analítica en semiplano superior

### _szego_projector (method) `def _szego_projector(self)`
- Defined: `main.py:286`
- Doc: Proyector P_E en base de Fourier positiva (dim reducida)

### _evaluation_functional (method) `def _evaluation_functional(self, state_weights)`
- Defined: `main.py:294`
- Doc: Φ_E[|Ψ⟩] = lim_{ε→0⁺} exp(∫ log(⟨Φ_i|E⟩ + ε) dμ(i))

### project (method) `def project(self, state_vector)`
- Defined: `main.py:310`
- Doc: P̂_E = P_E ∘ Φ_E (composición no lineal) - ROBUSTO CONTRA COLAPSO

### __init__ (method) `def __init__(self, universe, emuna)`
- Defined: `main.py:356`

### _effective_hamiltonian (method) `def _effective_hamiltonian(self)`
- Defined: `main.py:362`
- Doc: H_eff = Σ c_i H_i (mean-field: matriz 2×2 efectiva)

### _modular_dissipator (method) `def _modular_dissipator(self, state)`
- Defined: `main.py:372`
- Doc: L_mod[ρ] = Δ_S^α ρ Δ_S^α - ½{Δ_S^α, ρ}

### _nonlinear_term (method) `def _nonlinear_term(self, state)`
- Defined: `main.py:382`
- Doc: G[ρ, log ρ_∞] = g[ρ, log ρ_∞]

### evolve (method) `def evolve(self, rho0, t_span, n_steps)`
- Defined: `main.py:389`
...
### _free_hamiltonian (method) `def _free_hamiltonian(self)`
- Defined: `main.py:442`
- Doc: H_0: Modos colectivos con dispersión Ω(q) = Ω₀ + q² + χq³

### _loss_potential (method) `def _loss_potential(self)`
- Defined: `main.py:448`
- Doc: V_loss ∝ (r⊥/a₀)^{2α} con α=0.7

### _pt_symmetry_condition (method) `def _pt_symmetry_condition(self)`
- Defined: `main.py:456`
- Doc: Verificar κ/Ω < χ/Ω < 1

### coherence_quantum (method) `def coherence_quantum(self)`
- Defined: `main.py:462`
- Doc: Discordia cuántica aproximada (ejemplo: estado separable → 0)

### __init__ (method) `def __init__(self, n_nodes, seed)`
- Defined: `main.py:487`

### _generate_fractal_graph (method) `def _generate_fractal_graph(self)`
- Defined: `main.py:500`
- Doc: Grafo dirigido con distribución de grados power-law.

### _spectral_dimension (method) `def _spectral_dimension(self)`
- Defined: `main.py:510`
- Doc: d_s = -2 lim_{λ→0⁺} log N(λ)/log λ (sparse eigenvalue solver)

### _topological_ramsey (method) `def _topological_ramsey(self)`
- Defined: `main.py:527`
- Doc: R_Q(G) = min{n | β_{n-1}(G) > 0}

### _graph_to_distance_matrix (method) `def _graph_to_distance_matrix(self)`
- Defined: `main.py:548`
- Doc: Matriz de distancias shortest-path (sparse CSR)

### critical_percolation_time (method) `def critical_percolation_time(self)`
- Defined: `main.py:562`
- Doc: t_c = log⟨k⟩ / log R_Q * (N/N₀)^0.25

### is_coherent_subgraph (method) `def is_coherent_subgraph(self, subgraph_nodes)`
- Defined: `main.py:574`
- Doc: Verificar coherencia: subgrafo > 70% del total

### __init__ (method) `def __init__(self, network, universe)`
- Defined: `main.py:588`

### compute_entropy_gap (method) `def compute_entropy_gap(self)`
- Defined: `main.py:592`
- Doc: Δ_S* = ε_c en punto excepcional

### compute_pontryagin_number (method) `def compute_pontryagin_number(self)`
- Defined: `main.py:596`
- Doc: S_top[G] = χ(G)/|V| (número de Euler normalizado)

### compute_freedom (method) `def compute_freedom(self)`
- Defined: `main.py:607`
- Doc: L[G] = Δ_S* / S_top[G]

### is_gauge_invariant (method) `def is_gauge_invariant(self)`
- Defined: `main.py:618`
- Doc: |L[G] - 1| < 0.05 en estado crítico

### ising_quantum (method) `def ising_quantum(network)`
- Defined: `main.py:635`
- Doc: Modelo de Ising cuántico transversal en red fractal.

### syk4 (method) `def syk4(network)`
- Defined: `main.py:654`
- Doc: SYK₄ estándar (sin R-simetría Spin(7)).

### random_network (method) `def random_network(network)`
- Defined: `main.py:670`
- Doc: Red aleatoria Erdős-Rényi sin percolación cuántica.

### __init__ (method) `def __init__(self, resma, myelin, network)`
- Defined: `main.py:692`

### predict_all (method) `def predict_all(self)`
- Defined: `main.py:699`
- Doc: Predicciones RESMA 3.0

### _predict_diffraction_peak (method) `def _predict_diffraction_peak(self)`
- Defined: `main.py:710`
- Doc: q₀ = 2π/L_E8 (sin ajuste)

### compute_bayes_factor (method) `def compute_bayes_factor(self)`
- Defined: `main.py:715`
...
### simulate (method) `def simulate(n_leaves, n_nodes, seed)`
- Defined: `main3.py:233`

### dim (method) `def dim(a)`
- Defined: `main3.py:52`

### pt (method) `def pt(k, o, c)`
- Defined: `main3.py:56`

### size (method) `def size(n)`
- Defined: `main3.py:59`

### __post_init__ (method) `def __post_init__(self)`
- Defined: `main3.py:74`

### spectral_density (method) `def spectral_density(self, w)`
- Defined: `main3.py:78`
...
### _gibbs (method) `def _gibbs(self)`
- Defined: `main3.py:110`

### _global (method) `def _global(self)`
- Defined: `main3.py:119`

### __init__ (method) `def __init__(self, n_nodes, seed)`
- Defined: `main3.py:130`

### _spectral_dim (method) `def _spectral_dim(self, k)`
- Defined: `main3.py:139`

### _ramsey (method) `def _ramsey(self)`
- Defined: `main3.py:149`

### t_c (method) `def t_c(self)`
- Defined: `main3.py:163`

### __init__ (method) `def __init__(self, n_modes)`
...
### __init__ (method) `def __init__(self, pred_resma, nulls)`
- Defined: `main3.py:206`

### log_lik (method) `def log_lik(self, model_pred)`
- Defined: `main3.py:210`

### bf (method) `def bf(self)`
...
### verify_pt_condition (method) `def verify_pt_condition(cls)`
...
### _spectral_dim (method) `def _spectral_dim(self, k, n_fit)`
...
### simulate_resma_multiverse (method) `def simulate_resma_multiverse(n_leaves, n_nodes, seed, validate_empirical)`
- Defined: `main5.py:1052`
- Doc: Pipeline completo RESMA 4.0 con verificaciones de integridad y protocolo de validación.

### validate_dimension (method) `def validate_dimension(alpha, tolerance)`
- Defined: `main5.py:74`
...
### validate_spectral_dimension (method) `def validate_spectral_dimension(dim)`
- Defined: `main5.py:101`
- Doc: Validar rango físico para dimensión espectral

### validate_percolation_time (method) `def validate_percolation_time(t_c, expected, tolerance)`
...
### haagerup_weight (method) `def haagerup_weight(self)`
...
### compute_gibbs_free_energy (method) `def compute_gibbs_free_energy(self)`
...
### _compute_holonomy (method) `def _compute_holonomy(self)`
...
### compute_teleological_overlap (method) `def compute_teleological_overlap(self)`
...
### _stochastic_term (method) `def _stochastic_term(self, dt)`
...
### _normalize_density_matrix (method) `def _normalize_density_matrix(self, state)`
- Defined: `main5.py:500`
- Doc: Normalizar matriz densidad y forzar hermiticidad

### _is_physical_state (method) `def _is_physical_state(self, state)`
- Defined: `main5.py:509`
- Doc: Verificar si el estado es físico (hermitiano, traza=1, positivo)

### _correct_non_physical_state (method) `def _correct_non_physical_state(self, state)`
...
### _compute_scalar_mass (method) `def _compute_scalar_mass(self)`
...
### _compute_betti_numbers (method) `def _compute_betti_numbers(self)`
...
### compute_network_entropy (method) `def compute_network_entropy(self)`
...
### __init__ (method) `def __init__(self, resma, myelin, network, freedom)`
...
### compute_log_bayes_factor (method) `def compute_log_bayes_factor(self)`
- Defined: `main5.py:912`
- Doc: log(BF) = ΔAIC/2 donde AIC = 2k - 2ln(L)

### __init__ (method) `def __init__(self, predictions)`
- Defined: `main5.py:981`

### _define_protocols (method) `def _define_protocols(self)`
- Defined: `main5.py:985`
- Doc: Definir protocolos experimentales con parámetros técnicos

### evaluate_feasibility (method) `def evaluate_feasibility(self, budget, time_limit)`
- Defined: `main5.py:1014`
- Doc: Evaluar viabilidad del protocolo completo

### simulate_experimental_outcome (method) `def simulate_experimental_outcome(self, protocol_name)`
- Defined: `main5.py:1027`
- Doc: Simular resultado experimental con ruido realista

## monitor_extremo.py

### setup_matplotlib_for_plotting (function) `def setup_matplotlib_for_plotting()`
- Defined: `monitor_extremo.py:19`

### generar_datos_toxico (method) `def generar_datos_toxico()`
- Defined: `monitor_extremo.py:103`
- Doc: Genera datos diseñados específicamente para causar colapso

### experimento_colapso_forzado (method) `def experimento_colapso_forzado()`
- Defined: `monitor_extremo.py:126`
- Doc: Experimento diseñado para forzar el colapso del modelo

### generar_graficos_extremos (method) `def generar_graficos_extremos(historial)`
...
### calcular_libertad (method) `def calcular_libertad(self, weights)`
- Defined: `monitor_extremo.py:31`
- Doc: Calcula la métrica L (libertad) de una matriz de pesos

### evaluar_regimen (method) `def evaluar_regimen(self, L)`
...
### get_linear_layers (method) `def get_linear_layers(self)`
...
### generar_datos_mnist_rapido (method) `def generar_datos_mnist_rapido()`
- Defined: `quick_monitor.py:95`
- Doc: Genera datos sintéticos tipo MNIST para experimento rápido

### entrenar_modelo_rapido (method) `def entrenar_modelo_rapido()`
- Defined: `quick_monitor.py:116`
- Doc: Entrena modelo con monitoreo L en tiempo real

### generar_graficos_rapido (method) `def generar_graficos_rapido(historial)`
...
### __init__ (method) `def __init__(self, epsilon_c, patience, umbral_soberano, umbral_espurio, track_layers, verbose)`
- Defined: `resma2/monitor.py:36`
- Imported by: `resma2/main_experiments.py`, `resma2/resma_observer.py`

### _extract_weights (method) `def _extract_weights(self, model)`
- Defined: `resma2/monitor.py:50`
- Imported by: `resma2/main_experiments.py`, `resma2/resma_observer.py`

### _calculate_svd_metrics (method) `def _calculate_svd_metrics(self, weight_matrix)`
...
### add_quantum_noise (function) `def add_quantum_noise(tensor, noise_factor)`
- Defined: `resma2/resma_app_mnist.py:25`
- Doc: Inyecta ruido gaussiano simulando fluctuaciones de vacío
- Depends on: `resma2/resma_core.py`, `resma2/resma_observer.py`

### train (function) `def train(model, device, train_loader, optimizer, epoch, observer)`
...
### __init__ (method) `def __init__(self, in_features, out_features, q_order)`
- Defined: `resma2/resma_core.py:37`
- Imported by: `resma2/main_experiment.py`, `resma2/main_experiments.py`, `resma2/resma_app_mnist.py`, `resma2/resma_breakpoint.py`, `resma2/resma_combat_test.py`, `resma2/resma_noise_phase_test.py`, `resma2/resma_overload.py`, `resma2/resma_train.py`, `resma2/resma_vision.py`, `resma2/resma_vision_trained.py`

### _generate_ramsey_mask (method) `def _generate_ramsey_mask(self)`
...
### add_noise (function) `def add_noise(x, sigma)`
- Defined: `resma2/resma_noise_phase_test.py:34`
- Depends on: `resma2/resma_core.py`

### measure_entropy (function) `def measure_entropy(gate_tensor)`
...
### __init__ (method) `def __init__(self, model, epsilon_c)`
- Defined: `resma2/resma_observer.py:40`
- Depends on: `resma2/monitor.py`
- Imported by: `resma2/main_experiment.py`, `resma2/main_experiments.py`, `resma2/resma_app_mnist.py`

### _register_hooks (method) `def _register_hooks(self)`
...
### overload_test (function) `def overload_test()`
- Defined: `resma2/resma_overload.py:6`
- Depends on: `resma2/resma_core.py`

## resma2/resma_vision.py

### add_noise (function) `def add_noise(tensor, factor)`
- Defined: `resma2/resma_vision.py:11`
- Depends on: `resma2/resma_core.py`

### visualize_resma_perception (function) `def visualize_resma_perception()`
...
### visualize_trained_perception (function) `def visualize_trained_perception()`
- Defined: `resma2/resma_vision_trained.py:14`
- Depends on: `resma2/resma_core.py`

## resma4.10.py

### guardar_checkpoint (method) `def guardar_checkpoint(data, filename)`
- Defined: `resma4.10.py:877`

### cargar_checkpoint (method) `def cargar_checkpoint(filename)`
- Defined: `resma4.10.py:935`

### _make_serializable (method) `def _make_serializable(obj, depth, max_depth, _visited)`
- Defined: `resma4.10.py:963`
- Doc: Convierte objetos a formato serializable de forma segura.

### simulate_resma_garnier (method) `def simulate_resma_garnier(n_leaves, n_nodes, seed, resume, force_restart)`
...
### epsilon_critico (method) `def epsilon_critico(self)`
- Defined: `resma4.10.py:87`

### modulation_factor (method) `def modulation_factor(self)`
- Defined: `resma4.10.py:90`

### to_dict (method) `def to_dict(self)`
- Defined: `resma4.10.py:93`

### from_dict (method) `def from_dict(cls, data)`
- Defined: `resma4.10.py:103`

### __init__ (method) `def __init__(self, garnier, dimension)`
- Defined: `resma4.10.py:118`

### _generate_e8_roots (method) `def _generate_e8_roots()`
- Defined: `resma4.10.py:149`
- Doc: Genera las 240 raíces de E8 en R⁸.

### _idx (method) `def _idx(self, root_vec)`
- Defined: `resma4.10.py:189`
- Doc: Índice global (0..239) de una raíz.

### _compute_structure_constants (method) `def _compute_structure_constants(self)`
- Defined: `resma4.10.py:197`
- Doc: Constantes N_{α,β} para toda raíz α, β con α+β también raíz.

### _adjoint_matrix (method) `def _adjoint_matrix(self, cartan, roots_coeff)`
- Defined: `resma4.10.py:238`
- Doc: Matriz 248×248 de ad(X) para X = Σ c_i H_i + Σ d_γ E_γ.

### _construir_generadores_e8 (method) `def _construir_generadores_e8(self)`
- Defined: `resma4.10.py:330`
- Doc: Construye 3 generadores genuinos del álgebra E8 en la adjunta.

### _hadamard_generalizado (method) `def _hadamard_generalizado(self)`
- Defined: `resma4.10.py:399`

### operator (method) `def operator(self)`
- Defined: `resma4.10.py:408`

### calcular_alpha_modificado (method) `def calcular_alpha_modificado(self, alpha_base)`
- Defined: `resma4.10.py:423`

### __init__ (method) `def __init__(self, garnier)`
- Defined: `resma4.10.py:432`

### calcular_delta_s_loop (method) `def calcular_delta_s_loop(self, rho_red, b1)`
- Defined: `resma4.10.py:436`

### es_silencio_activo (method) `def es_silencio_activo(self, rho_red, b1)`
...
### __init__ (method) `def __init__(self, n_leaves, seed, leaves, measure, global_state, garnier)`
- Defined: `resma4.10.py:507`

### _initialize_leaves (method) `def _initialize_leaves(self)`
- Defined: `resma4.10.py:543`

### _generate_complete_measure (method) `def _generate_complete_measure(self)`
- Defined: `resma4.10.py:554`

### _aplicar_modulacion_garnier (method) `def _aplicar_modulacion_garnier(self, measure)`
- Defined: `resma4.10.py:583`

### _construct_global_state (method) `def _construct_global_state(self)`
- Defined: `resma4.10.py:594`

### _calcular_libertad (method) `def _calcular_libertad(self)`
- Defined: `resma4.10.py:603`

### _calcular_coherencia (method) `def _calcular_coherencia(self)`
- Defined: `resma4.10.py:606`

### __init__ (method) `def __init__(self, n_nodes, seed, graph, dim_spectral, ramsey, betti, garnier)`
- Defined: `resma4.10.py:615`

### _generate_realistic_modular_network (method) `def _generate_realistic_modular_network(self)`
...
### _calcular_rho_reducida (method) `def _calcular_rho_reducida(self)`
- Defined: `resma4.10.py:761`

### _validar_axioma_6 (method) `def _validar_axioma_6(self)`
- Defined: `resma4.10.py:769`

### __init__ (method) `def __init__(self, axon_length, radius, n_modes)`
...
### __init__ (method) `def __init__(self, universe, network, myelin)`
...
### log_resources (method) `def log_resources()`
...
### simulate_resma_complete (method) `def simulate_resma_complete(n_leaves, n_nodes, seed)`
...
### __init__ (method) `def __init__(self, universe, myelin, network)`
...
### simulate_resma_with_checkpointing (method) `def simulate_resma_with_checkpointing(n_leaves, n_nodes, seed, resume)`
...
### check_memory_limit (method) `def check_memory_limit()`
...
### __init__ (method) `def __init__(self, n_leaves, seed, leaves, measure, global_state)`
...
### __init__ (method) `def __init__(self, n_nodes, seed, graph, dim_spectral, ramsey, betti)`
...
### _make_serializable (method) `def _make_serializable(obj)`
...
### factor_escala (method) `def factor_escala(self, tiempo_idx)`
...
### aplicar_a_estado (method) `def aplicar_a_estado(self, estado)`
...
### __init__ (method) `def __init__(self, garnier, network)`
- Defined: `resma4.5.py:273`

### calcular_delta_s_loop (method) `def calcular_delta_s_loop(self, rho_red)`
- Defined: `resma4.5.py:278`
- Doc: ΔS_loop = S_vN(ρ_red) - log(b₁ + 1)

### _calcular_rho_reducida_aproximada (method) `def _calcular_rho_reducida_aproximada(self)`
- Defined: `resma4.5.py:299`
- Doc: Aproximación: ρ_red = diag(grados) / sum(grados)

### es_silencio_activo (method) `def es_silencio_activo(self, rho_red)`
- Defined: `resma4.5.py:307`
- Doc: Verifica Silencio-Activo y calcula Libertad L.

### umbral_percolacion (method) `def umbral_percolacion(self)`
...
### _aplicar_desdoblamiento_a_medida (method) `def _aplicar_desdoblamiento_a_medida(self, measure)`
...
### _calcular_libertad_universo (method) `def _calcular_libertad_universo(self)`
...
### validar_axioma_6 (method) `def validar_axioma_6(self)`
...
### simulate_resma_garnier (method) `def simulate_resma_garnier(n_leaves, n_nodes, seed, resume, force_restart, target_connectivity)`
...
### check_memory_limit (method) `def check_memory_limit(threshold)`
...
### _construir_generadores_E8_ZPE (method) `def _construir_generadores_E8_ZPE(self)`
- Defined: `resma4.6.py:246`
- Doc: GENERADORES CON CANCELACIÓN ZPE INTEGRADA

### _hadamard_generalizado_ZPE (method) `def _hadamard_generalizado_ZPE(self)`
...
### alpha_modificado (method) `def alpha_modificado(self, alpha_base)`
...
### modo_goldstone (method) `def modo_goldstone(self)`
...
### _calcular_zpe (method) `def _calcular_zpe(self)`
...
### _calcular_zpe_conectoma (method) `def _calcular_zpe_conectoma(self)`
...
### simulate_resma_garnier (method) `def simulate_resma_garnier(n_leaves, n_nodes, seed)`
...
### _compute_coupling (method) `def _compute_coupling(self)`
...
### _construir_generadores (method) `def _construir_generadores(self)`
...
### aplicar_modulacion (method) `def aplicar_modulacion(self, state_vector)`
...
### __init__ (method) `def __init__(self, n_leaves, seed, garnier)`
...
### _generate_modulated_measure (method) `def _generate_modulated_measure(self)`
...
### __init__ (method) `def __init__(self, n_nodes, seed, garnier)`
- Defined: `resma4.7.py:341`

### _generate_realistic_network (method) `def _generate_realistic_network(self)`
...
### __init__ (method) `def __init__(self, universe, network)`
...
### _construir_generadores_aleatorios (method) `def _construir_generadores_aleatorios(self)`
...
### cargar_datos (method) `def cargar_datos()`
...
### diagnosticar_modelo (function) `def diagnosticar_modelo(checkpoint_path)`
