...
**Classs:**
- `GarnierLayer` (line 8) - *Capa neuronal con temporalidad Garnier T³ (simplificada para demo)*

**Functions:**
- `demo_resma` (line 49) - *Demostración rápida de la arquitectura RESMA-Garnier*
- `__init__` (line 10)
- `forward` (line 27) - *Forward simplificado para demostración*
...
**Classs:**
- `GarnierLayer` (line 9) - *Capa neuronal con temporalidad Garnier T³*
- `SilencioActivoNetwork` (line 67) - *Red neuronal completa con arquitectura RESMA-Garnier*

**Functions:**
- `__init__` (line 11)
- `forward` (line 33) - *Forward con no-linealidad Garnier
Returns: (output, delta_s_loop)*
- `__init__` (line 69)
- `_build_garnier_topology` (line 111) - *Construcción BA+WS modular miniaturizada*
- `forward` (line 130) - *Forward completo con tracking de métricas de consciencia
Returns: (logits, metrics)*
- `activar_perfilado` (line 168) - *Activar perfilado de tiempo en toda la red*
- `mostrar_estadisticas_perfilado` (line 183) - *Mostrar estadísticas de perfilado*
- `entrenar_con_perfilado` (line 201) - *Entrenamiento con perfilado detallado*
- `entrenar` (line 240) - *Entrenamiento incorporado con regularización Garnier*
...
**Classs:**
- `SovereigntyMonitor` (line 26) - *Implementación del Sovereignty Monitor basada en RESMA*
- `ModeloGrande` (line 72) - *Modelo grande diseñado para colapsar con entrenamiento extremo*

**Functions:**
- `setup_matplotlib_for_plotting` (line 19)
- `generar_datos_toxico` (line 103) - *Genera datos diseñados específicamente para causar colapso*
- `experimento_colapso_forzado` (line 126) - *Experimento diseñado para forzar el colapso del modelo*
- `generar_graficos_extremos` (line 339) - *Genera gráficos del experimento extremo*
- `__init__` (line 28)
- `calcular_libertad` (line 31) - *Calcula la métrica L (libertad) de una matriz de pesos*
- `evaluar_regimen` (line 63) - *Evalúa el régimen del modelo*
- `__init__` (line 74)
- `forward` (line 88)
- `get_linear_layers` (line 100)
...
**Classs:**
- `SovereigntyMonitor` (line 26) - *Implementación del Sovereignty Monitor basada en RESMA*
- `ModeloMNISTPequeno` (line 72) - *Modelo CNN pequeño optimizado para entrenamiento rápido*

**Functions:**
- `setup_matplotlib_for_plotting` (line 19)
- `generar_datos_mnist_rapido` (line 95) - *Genera datos sintéticos tipo MNIST para experimento rápido*
- `entrenar_modelo_rapido` (line 116) - *Entrena modelo con monitoreo L en tiempo real*
- `generar_graficos_rapido` (line 295) - *Genera gráficos de resultados del experimento rápido*
- `__init__` (line 28)
- `calcular_libertad` (line 31) - *Calcula la métrica L (libertad) de una matriz de pesos*
- `evaluar_regimen` (line 63) - *Evalúa el régimen del modelo*
- `__init__` (line 74)
- `forward` (line 83)
- `get_linear_layers` (line 92)
...
**Functions:**
- `set_seed` (line 26)
- `run_experiment` (line 31)

#### `main_experiments.py`
**Path:** `resma2/main_experiments.py`

**Functions:**
- `inject_noise` (line 24)
- `train_epoch` (line 27)
- `run` (line 61)
...
**Classs:**
- `Regime` (line 12)
- `LayerDiagnostics` (line 18)
- `EpochSnapshot` (line 27)
- `SovereigntyMonitor` (line 35)

**Functions:**
- `__init__` (line 36)
- `_extract_weights` (line 50)
- `_calculate_svd_metrics` (line 58)
- `calcular_libertad` (line 84)
- `calculate` (line 92)
...
**Functions:**
- `add_quantum_noise` (line 25) - *Inyecta ruido gaussiano simulando fluctuaciones de vacío*
- `train` (line 30)
- `main` (line 65)
...
**Classs:**
- `PTSymmetricActivation` (line 14)
- `E8LatticeLayer` (line 35)
- `RESMABrain` (line 65)
...
**Functions:**
- `add_noise` (line 34)
- `measure_entropy` (line 37)

#### `resma_observer.py`
**Path:** `resma2/resma_observer.py`

**Classs:**
- `QuantumState` (line 27) - *Snapshot del estado físico-estructural de la red*
- `RESMAObserver` (line 39)

**Functions:**
- `to_dict` (line 36)
- `__init__` (line 40)
- `_register_hooks` (line 51) - *Inyecta sondas en las capas PT para leer telemetría en tiempo real*
- `step` (line 68) - *Ejecutar al final de cada época de entrenamiento/validación.
Fusiona métricas y determina la fase.*
- `report` (line 106) - *Imprime reporte formateado a consola*
- `plot_phase_space` (line 118) - *Genera el diagrama de fase: Estructura vs Dinámica*
- `hook_fn` (line 53)
...
**Functions:**
- `add_noise` (line 11)
- `visualize_resma_perception` (line 14)
...
**Functions:**
- `add_noise` (line 11)
- `visualize_trained_perception` (line 14)

#### `resma4.10.py`
**Path:** `resma4.10.py`

**Classs:**
- `RESMAConstants` (line 35)
- `GarnierTresTiempos` (line 72)
- `OperadorDesdoblamiento` (line 112) - *Operador de desdoblamiento D̂_G(φ) sobre el álgebra E8 genuina.
Construcción: sistema de raíces E8 → base de Chevalley → representación adjunta 248.*
- `SilencioActivoMonitor` (line 431)
- `QuantumLeaf` (line 459)
- `RESMAUniverse` (line 506)
- `NeuralNetworkRESMA` (line 614)
- `MyelinCavity` (line 782)
- `ExperimentalPredictions` (line 818)
- `ResourceMonitor` (line 865)

**Functions:**
- `guardar_checkpoint` (line 877)
- `cargar_checkpoint` (line 935)
- `_make_serializable` (line 963) - *Convierte objetos a formato serializable de forma segura.
...
- `simulate_resma_garnier` (line 1067)
- `verify_pt_condition` (line 51)
- `__post_init__` (line 75)
- `epsilon_critico` (line 87)
- `modulation_factor` (line 90)
- `to_dict` (line 93)
- `from_dict` (line 103)
- `__init__` (line 118)
- `_generate_e8_roots` (line 149) - *Genera las 240 raíces de E8 en R⁸.
Retorna array (240,8) con forma: [positivas (120) | negativas (120)]
donde neg[j] = -pos[j].*
- `_idx` (line 189) - *Índice global (0..239) de una raíz.*
- `_compute_structure_constants` (line 197) - *Constantes N_{α,β} para toda raíz α, β con α+β también raíz.
...
- `_adjoint_matrix` (line 238) - *Matriz 248×248 de ad(X) para X = Σ c_i H_i + Σ d_γ E_γ.
...
- `_construir_generadores_e8` (line 330) - *Construye 3 generadores genuinos del álgebra E8 en la adjunta.
...
- `_hadamard_generalizado` (line 399)
- `operator` (line 408)
- `calcular_alpha_modificado` (line 423)
- `__init__` (line 432)
- `calcular_delta_s_loop` (line 436)
- `es_silencio_activo` (line 443)
- `__post_init__` (line 466)
- `spectral_density` (line 470)
- `bures_distance` (line 476)
- `__init__` (line 507)
- `_initialize_leaves` (line 543)
- `_generate_complete_measure` (line 554)
- `_aplicar_modulacion_garnier` (line 583)
- `_construct_global_state` (line 594)
- `_calcular_libertad` (line 603)
- `_calcular_coherencia` (line 606)
- `__init__` (line 615)
- `_generate_realistic_modular_network` (line 653)
- `_compute_betti_numbers` (line 727)
- `_spectral_dimension` (line 735)
- `_topological_ramsey` (line 757)
- `_calcular_rho_reducida` (line 761)
- `_validar_axioma_6` (line 769)
- `__init__` (line 783)
- `_free_hamiltonian` (line 800)
- `_loss_potential` (line 805)
- `_compute_scalar_mass` (line 811)
- `__init__` (line 819)
- `compute_log_bayes_factor` (line 824)
- `get_memory_gb` (line 867)
- `log_resources` (line 872)
...
- `QuantumLeaf` (line 459)
- `RESMAUniverse` (line 506)
- `NeuralNetworkRESMA` (line 639)
- `MyelinCavity` (line 807)
- `ExperimentalPredictions` (line 843)
- `ResourceMonitor` (line 890)

**Functions:**
- `guardar_checkpoint` (line 902)
- `cargar_checkpoint` (line 960)
- `_make_serializable` (line 988) - *Convierte objetos a formato serializable de forma segura.
...
Args:
    ...
    max_depth: Profundidad máxima permitida
    _visited: Diccionario de objetos ya procesados (para referencias circulares)*
- `simulate_resma_garnier` (line 1092)
- `verify_pt_condition` (line 51)
- `__post_init__` (line 75)
- `epsilon_critico` (line 87)
- `modulation_factor` (line 90)
...
- `__init__` (line 507)
- `_initialize_leaves` (line 543)
- `_generate_complete_measure` (line 553)
- `_aplicar_modulacion_garnier` (line 608)
- `_construct_global_state` (line 619)
- `_calcular_libertad` (line 628)
- `_calcular_coherencia` (line 631)
- `__init__` (line 640)
- `_generate_realistic_modular_network` (line 678)
- `_compute_betti_numbers` (line 752)
- `_spectral_dimension` (line 760)
- `_topological_ramsey` (line 782)
- `_calcular_rho_reducida` (line 786)
- `_validar_axioma_6` (line 794)
- `__init__` (line 808)
- `_free_hamiltonian` (line 825)
- `_loss_potential` (line 830)
- `_compute_scalar_mass` (line 836)
- `__init__` (line 844)
- `compute_log_bayes_factor` (line 849)
- `get_memory_gb` (line 892)
- `log_resources` (line 897)
...
- `NeuralNetworkRESMA` (line 659) - *Red neuronal con validación ZPE-Silencio*
- `ExperimentalPredictions` (line 853) - *Cálculos experimentales unificados ZPE-Silencio*
...
- `simulate_resma_garnier` (line 906) - *Pipeline completo RESMA 4.3.5 con antagonismo ZPE-Silencio*
...
- `__init__` (line 662)
- `_generate_fractal_graph` (line 711) - *Genera grafo con densidad 0.75 (conectoma humano)*
- `_spectral_dimension` (line 753) - *Dimensión espectral con ZPE*
- `_topological_ramsey` (line 777) - *Ramsey topológico*
- `_compute_betti_numbers` (line 788) - *Números de Betti reales*
- `_calcular_rho_reducida` (line 804) - *Matriz densidad con supresión ZPE*
- `_calcular_zpe_conectoma` (line 820) - ***ENERGÍA ZPE DEL CONECTOMA**:
E_ZPE = Σ_i ½ħω_i (modos de Laplaciano)*
- `validar_axioma_6` (line 836) - ***AXIOMA 6**: Conectividad > 70% para soberanía*
- `__init__` (line 856)
- `compute_log_bayes_factor` (line 861) - *Calcula Factor de Bayes con antagonismo ZPE-Silencio*
...
**Classs:**
- `SovereigntyMonitor` (line 29) - *Implementación del Sovereignty Monitor basada en RESMA

Calcula L = 1 / (|S_vN(ρ) − log(rank(W) + 1)| + ε_c)*
- `CNNMNIST` (line 94) - *CNN para MNIST con arquitectura diseñada para monitoreo*
- `ExperimentoCompleto` (line 146) - *Experimento completo para validar el Sovereignty Monitor*

**Functions:**
- `setup_matplotlib_for_plotting` (line 21) - *Setup matplotlib para visualización*
- `cargar_datos` (line 126) - *Carga y prepara el dataset MNIST*
- `main` (line 433) - *Función principal*
- `__init__` (line 35)
- `calcular_libertad` (line 38) - *Calcula la métrica L (libertad) de una matriz de pesos

Returns:
    tuple: (L, S_vn, rank_effective)*
- `evaluar_regimen` (line 85) - *Evalúa el régimen del modelo*
- `__init__` (line 96)
- `forward` (line 110)
- `get_linear_layers` (line 122) - *Retorna todas las capas lineales para monitoreo*
- `__init__` (line 149)
- `calcular_metricas_sovereignty` (line 189) - *Calcula métricas L para todas las capas lineales*
- `entrenar_epoca` (line 210) - *Entrena una época completa*
- `evaluar_epoca` (line 233) - *Evalúa el modelo en el conjunto de validación*
- `ejecutar_experimento` (line 253) - *Ejecuta el experimento completo*
- `generar_graficos` (line 362) - *Genera gráficos comprehensivos de resultados*

#### `test_simple.py`
**Path:** `test_simple.py`

**Functions:**
- `test_basic_math` (line 8) - *Test de las matemáticas básicas RESMA*
...
**Functions:**
- `setup_matplotlib_for_plotting` (line 6) - *Setup matplotlib and seaborn for plotting with proper configuration.
Call this function before creating any plots to ensure proper rendering.*
- `diagnosticar_modelo` (line 30) - *Cargar y visualizar estado de red entrenada*
