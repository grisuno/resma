...
> Generated offline by **readmenator**. 42 files, 905 symbols, 404 imports. Supports C, C++, Python, Go, Rust, JS/TS, Java, C#, Shell, PHP, Dart, GDScript, Nim, ASM, Ruby, Swift, Kotlin, Scala, Lua, Elixir.
...
- `monitor.py` <-> `resma_breakpoint.py` (3 hops, across 2 communities)
- `monitor.py` <-> `resma_combat_test.py` (3 hops, across 2 communities)
- `monitor.py` <-> `resma_noise_phase_test.py` (3 hops, across 2 communities)
- `monitor.py` <-> `resma_overload.py` (3 hops, across 2 communities)
- `monitor.py` <-> `resma_train.py` (3 hops, across 2 communities)
...
- Why are monitor.py and resma_breakpoint.py connected through 3 hops across 2 communities?
...
```mermaid
classDiagram
  class demo_mini_resma_py_GarnierLayer {
    <<class>>
    +demo_resma()
    +__init__(self, in_features, out_features, device)
    +forward(self, x)
  }
  class garnier_nn_py_GarnierLayer {
    <<class>>
    +__init__(self, in_features, out_features, device)
    +forward(self, x)
    +__init__(self, layer_sizes, scale, device)
    +_build_garnier_topology(self)
    +forward(self, x)
    +activar_perfilado(self)
    +mostrar_estadisticas_perfilado(self)
    +entrenar_con_perfilado(self, train_loader, epochs, lr)
    +entrenar(self, train_loader, epochs, lr)
  }
  class garnier_nn_py_SilencioActivoNetwork {
    <<class>>
    +__init__(self, in_features, out_features, device)
    +forward(self, x)
    +__init__(self, layer_sizes, scale, device)
  ...
  class main_py_RESMAConstants {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
    +validate_connectome_size(n_nodes)
    +__post_init__(self)
    +spectral_density(self, omega)
    +modular_entropy(self)
    +bures_distance(self, other)
    +_spectral_moments(self, n)
    +__init__(self, n_leaves, seed)
  }
  class main_py_PhysicalValidator {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main_py_BranchingOperator {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main_py_LindbladFractalDynamics {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main_py_NeuralNetworkRESMA {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main_py_FreedomInvariant {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main_py_ExperimentalPredictions {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_PhysicalValidator {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_BranchingOperator {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_LindbladFractalDynamics {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_NeuralNetworkRESMA {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_FreedomInvariant {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main2_py_ExperimentalPredictions {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed)
    +validate_dimension(alpha)
    +validate_pt_symmetry(kappa, Omega, chi)
  ...
  class main3_py_RC {
    <<class>>
    +simulate(n_leaves, n_nodes, seed)
    +dim(a)
    +pt(k, o, c)
    +size(n)
    +__post_init__(self)
  ...
  class main4_py_py_MyelinCavity {
    <<class>>
    +simulate(n_leaves, n_nodes, seed)
    +dim(a)
    +pt(k, o, c)
  ...
  class main5_py_RESMAConstants {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed, validate_empirical)
    +validate_dimension(alpha, tolerance)
    +validate_pt_symmetry(kappa, Omega, chi)
    +validate_connectome_size(n_nodes)
    +validate_spectral_dimension(dim)
    +validate_percolation_time(t_c, expected, tolerance)
    +__post_init__(self)
    +spectral_density(self, omega)
    +modular_entropy(self)
    +bures_distance(self, other)
  }
  class main5_py_PhysicalValidator {
    <<class>>
    +simulate_resma_multiverse(n_leaves, n_nodes, seed, validate_empirical)
    +validate_dimension(alpha, tolerance)
    +validate_pt_symmetry(kappa, Omega, chi)
